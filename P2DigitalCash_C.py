...
def bit_com():
    #order1=list[r1,split(cust_id,r1)]
    i11=r1
    i12=split(cust_id,r1)

    #order2=list[r2,split(cust_id,r2)]
    i21=r2
    i22=split(cust_id,r2)

    #order3=list[r3,split(cust_id,r3)]
    i31=r3
    ...
    #"".join(["%x" % (int(i111,16) ^ int(i112,16))^int(i11,16) for (i11,i112,i11) in zip(mes1 ,y)]
...
def blind_orders():
    ...
    mes1=(int(i321, 16)^int(i322, 16)^int(i32, 16)*int(rand_mult,16))
    mes2 =  (int(i121, 16)^int(i122, 16)^int(i12, 16)% int(rand_mult,16))

    mes3 =  (int(i211, 16)^int(i212, 16)^int(i21, 16)% int(rand_mult,16))
    mes4 =  (int(i221, 16)^int(i222, 16)^int(i22, 16)% int(rand_mult,16))

    mes5 =  (int(i311,16)^int(i312,16)^int(i31,16) % int(rand_mult,16))
    mes6 =  (int(i321, 16)^int(i322, 16)^int(i32, 16)% int(rand_mult,16))
    print mes1
